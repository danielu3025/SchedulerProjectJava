...
public class PhoneTable extends JFrame {
    ...
    public PhoneTable(Connection con) throws HeadlessException, SQLException {
        ...
        PreparedStatement searched = con.prepareStatement(
                "SELECT P.ID, P.PHONE,L.NAME ,L.LAST_NAME FROM PHONE_TABLE AS P JOIN LECTURERS_TABLE AS L ON P.ID = L.ID");
